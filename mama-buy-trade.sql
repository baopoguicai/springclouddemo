...
Date: 2019-09-26 11:24:38
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for message_event_publish
-- ----------------------------
DROP TABLE IF EXISTS `message_event_publish`;
CREATE TABLE `message_event_publish` (
...
-- ----------------------------
-- Records of message_event_publish
-- ----------------------------

-- ----------------------------
-- Table structure for messge_event_process
-- ----------------------------
DROP TABLE IF EXISTS `messge_event_process`;
CREATE TABLE `messge_event_process` (
  `id` int(11) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `payload` varchar(255) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
-- ----------------------------
-- Records of messge_event_process
-- ----------------------------
...
CREATE TABLE `user_bonus_points` (
  `id` int(11) DEFAULT NULL,
  `user_uuid` int(11) DEFAULT NULL COMMENT '用户uuid',
  `points` varchar(255) DEFAULT NULL COMMENT '用户积分'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
